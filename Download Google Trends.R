...
downloadDir="C:/Users/dominik.cichon/Downloads/Trends"
setwd(downloadDir)
seach_word="DAX"


URL_GT=function(keyword="", country="DE", region=NA, year=NA, month=1, length=3){
  
  start="http://www.google.com/trends/trendsReport?hl=de&q="
